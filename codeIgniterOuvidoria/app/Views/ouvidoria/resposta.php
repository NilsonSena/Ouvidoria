            ...
            <div class="col-md-6 col-md-offset-3">
                ...
                <form action="resposta" method="POST">
                    ...
                    <?php
                        ...
                        ?>
                        <label for="reclamacao">Resposta abaixo:</label>
                        ...
                        ?>
                        <textarea class="form-control is-invalid" name="resposta" id="resposta" maxlength="1000" rows="8" disabled><?php 
                            if(!isset($dadosPesquisa)){
                                echo '<tr>No data found</tr>';
                            }else{
                                foreach($dadosPesquisa as $key=>$value):
                        ...
                        <textarea class="form-control is-invalid" name="sei" id="sei" maxlength="1000" disabled><?php 
                            if(!isset($dadosPesquisa)){
                                echo '<tr>No data found</tr>';
                            }else{
                                foreach($dadosPesquisa as $key=>$value):
