...
class RespostaADM extends Controller {
	...
	public function index(){
        ...
        try{
            ...
            if(isset($_GET["var"])){
                ...
                return view('ouvidoria\respostaADM.php', $data);
            }
            ...
            try{
                ...
                if(!empty($_POST['resposta'])){
                    ...
                    try{
                        ...
                        //verifica se existe alguma resposta para esse protocolo, caso exista 

                        $protoConsulta = $db->query("SELECT protocolo_id FROM resposta WHERE protocolo_id = '$protocolo';");  
                        
                        $x = 1;

                        foreach ($protoConsulta->getResult() as $row) {
                            $x++;
                        }
                        ...
                        if($x == 1){
                            ...
                            $db->query("UPDATE `resposta` SET `sei` = '$sei', `dtHoraResposta` = '$horaData', `idusuario` = '$idusuario', `resposta` = '$resposta' WHERE `protocolo_id` = '$protocolo';");
                        }
            ...
            return view('ouvidoria\respostaADM.php');
